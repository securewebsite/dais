        ...
        foreach (Session::p()->data['compare'] as $key => $product_id) {
            ...
            if ($product_info) {
                ...
                $data['products'][$product_id] = array(
                    ...
                    'weight'       => Weight::format($product_info['weight'], $product_info['weight_class_id']), 
                    'length'       => Length::format($product_info['length'], $product_info['length_class_id']), 
                    'width'        => Length::format($product_info['width'], $product_info['length_class_id']), 
                    'height'       => Length::format($product_info['height'], $product_info['length_class_id']), 
