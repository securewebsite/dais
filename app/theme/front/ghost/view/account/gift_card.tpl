			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<?php foreach ($gift_card_themes as $gift_card_theme) { ?>
						<div class="radio"><label for="gift_card-<?= $gift_card_theme['gift_card_theme_id']; ?>">
						<?php if ($gift_card_theme['gift_card_theme_id'] == $gift_card_theme_id) { ?>
							<input type="radio" name="gift_card_theme_id" value="<?= $gift_card_theme['gift_card_theme_id']; ?>" id="gift_card-<?= $gift_card_theme['gift_card_theme_id']; ?>" checked="">
						<?php } else { ?>
							<input type="radio" name="gift_card_theme_id" value="<?= $gift_card_theme['gift_card_theme_id']; ?>" id="gift_card-<?= $gift_card_theme['gift_card_theme_id']; ?>">
						<?php } ?>
						<?= $gift_card_theme['name']; ?></label></div>
					<?php } ?>
					<?php if ($error_theme) { ?>
