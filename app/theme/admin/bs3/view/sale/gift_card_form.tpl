...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ul class="nav nav-tabs"><li><a href="#tab-general" data-toggle="tab"><?= $lang_tab_general; ?></a></li>
			<?php if ($gift_card_id) { ?>
			<li><a href="#tab-history" data-toggle="tab"><?= $lang_tab_gift_card_history; ?></a></li>
			<?php } ?>
		</ul>
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="tab-content">
						...
						<div class="control-field col-sm-4">
							<select name="gift_card_theme_id" class="form-control">
								<?php foreach ($gift_card_themes as $gift_card_theme) { ?>
									...
									<option value="<?= $gift_card_theme['gift_card_theme_id']; ?>" selected><?= $gift_card_theme['name']; ?></option>
									<?php } else { ?>
									<option value="<?= $gift_card_theme['gift_card_theme_id']; ?>"><?= $gift_card_theme['name']; ?></option>
									<?php } ?>
								<?php } ?>
							</select>
						</div>
				...
				<div class="tab-pane" id="tab-history">
					<div id="history" data-href="index.php?route=sale/gift_card/history&token=<?= $token; ?>&gift_card_id=<?= $gift_card_id; ?>"></div>
				</div>
				<?php } ?>
			</div>
		</form>
