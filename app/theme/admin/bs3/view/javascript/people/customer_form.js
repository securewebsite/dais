...
function country(a,b,c){
	...
	$.ajax({
		url:'people/customer/country/country_id/'+a.value,
		dataType:'json',
		beforeSend:function(){
...
$(document).on('click', '#button-reward', function(e){
	...
	$.ajax({
		url:'people/customer/reward/customer_id/<?= $customer_id; ?>',
		type:'post',
		dataType:'html',
...
function removeBanIP(ip) {
	...
	$.ajax({
		url:'people/customer/removebanip',
		type:'post',
		dataType:'json',
		data:'ip='+encodeURIComponent(ip),
		beforeSend:function(){
