...
function addWidget(){	
	...
	html += '<td><select name="blog_search_widget['+widget_row+'][layout_id]" class="form-control">';
	<?php foreach ($layouts as $layout) { ?>
	html += '<option value="<?= $layout['layout_id']; ?>"><?= addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '</select></td>';
	html += '<td><select name="blog_search_widget['+widget_row+'][position]" class="form-control">';
	...
	html += '<label class="btn btn-default active" title="<?= $lang_text_enabled; ?>"><input type="radio" name="blog_search_widget['+widget_row+'][status]" value="1" checked=""><i class="fa fa-play"></i></label>';
	html += '<label class="btn btn-default" title="<?= $lang_text_disabled; ?>"><input type="radio" name="blog_search_widget['+widget_row+'][status]" value="0"><i class="fa fa-pause"></i></label>';
	html += '</div></td>';
	html += '<td class="text-right"><input type="text" name="blog_search_widget['+widget_row+'][sort_order]" value="" class="form-control"></td>';
