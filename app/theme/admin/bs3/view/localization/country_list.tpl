			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th class="hidden-xs"><a href="<?= $sort_iso_code_2; ?>"><?= $lang_column_iso_code_2; echo ($sort == 'iso_code_2') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="hidden-xs"><a href="<?= $sort_iso_code_3; ?>"><?= $lang_column_iso_code_3; echo ($sort == 'iso_code_3') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
