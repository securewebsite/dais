...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-ppexpress" class="form-horizontal">
			<input type="hidden" name="paypal_express_login_seamless" value="1">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab-api-details">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypal_express_username" value="<?= $paypal_express_username; ?>" 
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypal_express_password" value="<?= $paypal_express_password; ?>" 
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypal_express_signature" value="<?= $paypal_express_signature; ?>" 
			...
			<div class="tab-pane" id="tab-general">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_test" id="input-live-demo" class="form-control">
						<?php if ($paypal_express_test) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_debug" id="input-debug" class="form-control">
						<?php if ($paypal_express_debug) { ?>
							<option value="1" selected="selected"><?= $lang_text_yes; ?></option>
							<option value="0"><?= $lang_text_no; ?></option>
						<?php } else { ?>
							<option value="1"><?= $lang_text_yes; ?></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_currency" id="input-currency" class="form-control">
						<?php foreach ($currency_codes as $code) { ?>
						<?php if ($code == $paypal_express_currency) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_recurring_cancel_status" id="input-recurring-cancel" class="form-control">
						<?php if ($paypal_express_recurring_cancel_status) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_method" id="input-method" class="form-control">
							<option value="Sale" <?php  echo (($paypal_express_method == '' || $paypal_express_method == 'Sale') ? 'selected="selected"' : ''); ?>><?= $lang_text_sale; ?></option>
							<option value="Authorization" <?= ($paypal_express_method == 'Authorization' ? 'selected="selected"' : ''); ?>><?= $lang_text_authorization; ?></option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="paypal_express_total" value="<?= $paypal_express_total; ?>" id="input-total" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="input-sort-order"><?= $lang_entry_sort_order; ?></label>
					<div class="col-sm-10">
						<input type="text" name="paypal_express_sort_order" value="<?= $paypal_express_sort_order; ?>" placeholder="<?= $lang_entry_sort_order; ?>" id="input-sort-order" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="input-geo-zone"><?= $lang_entry_geo_zone; ?></label>
					<div class="col-sm-10">
						<select name="paypal_express_geo_zone_id" id="input-geo-zone" class="form-control">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_status" id="input-status" class="form-control">
			...
			<div class="tab-pane" id="tab-status">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_canceled_reversal_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_canceled_reversal_status_id) { ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_completed_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_completed_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_denied_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_denied_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_expired_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_expired_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_failed_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_failed_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_pending_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_pending_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_processed_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_processed_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_refunded_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_refunded_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_reversed_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_reversed_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_voided_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypal_express_voided_status_id) { ?>
							<option value="<?= $order_status['order_status_id']; ?>" selected="selected"><?= $order_status['name']; ?></option>
						<?php } else { ?>
							<option value="<?= $order_status['order_status_id']; ?>"><?= $order_status['name']; ?></option>
						<?php } ?>
			...
			<div class="tab-pane" id="tab-customise">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select name="paypal_express_allow_note" id="input-notes" class="form-control">
						<?php if ($paypal_express_allow_note) { ?>
							<option value="1" selected="selected"><?= $lang_text_yes; ?></option>
							<option value="0"><?= $lang_text_no; ?></option>
						<?php } else { ?>
							<option value="1"><?= $lang_text_yes; ?></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="paypal_express_page_colour" value="<?= $paypal_express_page_colour; ?>" id="input-page-color" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?= $thumb; ?>" alt="" title="" data-placeholder="<?= $no_image; ?>" /></a>
						<input type="hidden" name="paypal_express_logo" value="<?= $paypal_express_logo; ?>" id="input-image" />
					</div>
				</div>
			</div>
		</div>
