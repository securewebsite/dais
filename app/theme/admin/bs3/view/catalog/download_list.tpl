			...
			<table class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th><a href="<?= $sort_name; ?>"><?= $lang_column_name; echo ($sort == 'dd.name') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
						<th class="text-right hidden-xs"><a href="<?= $sort_remaining; ?>"><?= $lang_column_remaining; echo ($sort == 'd.remaining') ? '<i class="caret caret-' . strtolower($order) . '"></i>' : ''; ?></a></th>
