...
--
-- Table structure for table `dais_zone`
--

DROP TABLE IF EXISTS `dais_zone`;
CREATE TABLE IF NOT EXISTS `dais_zone` (
...
--
-- Dumping data for table `dais_zone`
--

INSERT INTO `dais_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
(69, 3, 'Adrar', 'ADR', 0),
