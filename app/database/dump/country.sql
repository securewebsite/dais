...
--
-- Table structure for table `dais_country`
--

DROP TABLE IF EXISTS `dais_country`;
CREATE TABLE IF NOT EXISTS `dais_country` (
...
--
-- Dumping data for table `dais_country`
--

INSERT INTO `dais_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
