...
--
-- Table structure for table `dais_coupon`
--

DROP TABLE IF EXISTS `dais_coupon`;
CREATE TABLE IF NOT EXISTS `dais_coupon` (
...
--
-- Dumping data for table `dais_coupon`
--

INSERT INTO `dais_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
