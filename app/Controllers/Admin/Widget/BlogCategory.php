...
class BlogCategory extends Controller {
    ...
    public function index() {
        ...
        Breadcrumb::add('lang_heading_title', 'widget/blog_category');
        
        $data['action'] = Url::link('widget/blog_category', 'token=' . $this->session->data['token'], 'SSL');
        ...
        } elseif (Config::get('blogcategory_widget')) {
            $data['widgets'] = Config::get('blogcategory_widget');
        }
    ...
    protected function validate() {
        if (!User::hasPermission('modify', 'widget/blogcategory')) {
