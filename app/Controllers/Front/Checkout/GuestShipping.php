...
class GuestShipping extends Controller {
    public function index() {
        ...
        $this->response->setOutput(Theme::view('checkout/guest_shipping', $data));
    }
    ...
    public function validate() {
        ...
        if (!Config::get('config_guest_checkout') || Config::get('config_customer_price') || $this->cart->hasDownload()) {
            $json['redirect'] = Url::link('checkout/checkout', '', 'SSL');
        }
