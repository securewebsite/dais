...
class Recurring extends Controller {
    public function index() {
        ...
        $this->response->setOutput(Theme::view('account/recurring_list', $data));
    }
    ...
    public function info() {
        ...
        if ($recurring):
            ...
            Theme::set_controller('header', 'shop/header');
            Theme::set_controller('footer', 'shop/footer');
            Theme::set_controller('buttons', 'payment/' . $recurring['payment_code'] . '/recurringButtons');
            
            $data = Theme::render_controllers($data);
            
            $this->response->setOutput(Theme::view('account/recurring_info', $data));
        else:
            $this->response->redirect(Url::link('account/recurring', '', 'SSL'));
        endif;
    }
}
