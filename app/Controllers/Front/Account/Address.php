...
class Address extends Controller {
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect(Url::link('account/address', '', 'SSL'));
        }
    ...
    protected function getList() {
        ...
        $this->response->setOutput(Theme::view('account/address_list', $data));
    }
    ...
    protected function getForm() {
        ...
        $this->response->setOutput(Theme::view('account/address_form', $data));
    }
