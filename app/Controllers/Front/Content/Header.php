...
class Header extends Controller {
    public function index() {
        ...
        $data['text_logged']   = sprintf(Lang::get('lang_text_logged'), Url::link('account/dashboard', '', 'SSL'), $this->customer->getFirstName(), Url::link('account/logout', '', 'SSL'));
        ...
        return Theme::view('content/header', $data);
    }
}
