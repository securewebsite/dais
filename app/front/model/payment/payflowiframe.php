...
class Payflowiframe extends Model {
    ...
    public function call($data) {
        $default_parameters = array('USER' => $this->config->get('payflowiframe_user'), 'VENDOR' => $this->config->get('payflowiframe_vendor'), 'PWD' => $this->config->get('payflowiframe_password'), 'PARTNER' => $this->config->get('payflowiframe_partner'), 'BUTTONSOURCE' => 'Dais_Cart_PFP',);
