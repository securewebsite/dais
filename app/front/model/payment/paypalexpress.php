...
class Paypalexpress extends Model {
    ...
    public function call($data) {
        ...
        $settings = array('USER' => $this->config->get('paypalexpress_username'), 'PWD' => $this->config->get('paypalexpress_password'), 'SIGNATURE' => $this->config->get('paypalexpress_signature'), 'VERSION' => '109.0', 'BUTTONSOURCE' => 'Dais_1.0_EC',);
