...
class Fraud extends Model {
        ...
        if ($fraud_info) {
            ...
            */
            ...
            if ($response) {
                ...
                DB::query("INSERT INTO `" . DB::prefix() . "order_fraud` SET order_id = '" . (int)$order_id . "', customer_id = '" . (int)$customer_id . "', country_match = '" . DB::escape($country_match) . "', country_code = '" . DB::escape($country_code) . "', high_risk_country = '" . DB::escape($high_risk_country) . "', distance = '" . (int)$distance . "', ip_region = '" . DB::escape($ip_region) . "', ip_city = '" . DB::escape($ip_city) . "', ip_latitude = '" . DB::escape($ip_latitude) . "', ip_longitude = '" . DB::escape($ip_longitude) . "', ip_isp = '" . DB::escape($ip_isp) . "', ip_org = '" . DB::escape($ip_org) . "', ip_asnum = '" . (int)$ip_asnum . "', ip_user_type = '" . DB::escape($ip_user_type) . "', ip_country_confidence = '" . DB::escape($ip_country_confidence) . "', ip_region_confidence = '" . DB::escape($ip_region_confidence) . "', ip_city_confidence = '" . DB::escape($ip_city_confidence) . "', ip_postal_confidence = '" . DB::escape($ip_postal_confidence) . "', ip_postal_code = '" . DB::escape($ip_postal_code) . "', ip_accuracy_radius = '" . (int)$ip_accuracy_radius . "', ip_net_speed_cell = '" . DB::escape($ip_net_speed_cell) . "', ip_metro_code = '" . (int)$ip_metro_code . "', ip_area_code = '" . (int)$ip_area_code . "', ip_time_zone = '" . DB::escape($ip_time_zone) . "', ip_region_name = '" . DB::escape($ip_region_name) . "', ip_domain = '" . DB::escape($ip_domain) . "', ip_country_name = '" . DB::escape($ip_country_name) . "', ip_continent_code = '" . DB::escape($ip_continent_code) . "', ip_corporate_proxy = '" . DB::escape($ip_corporate_proxy) . "', anonymous_proxy = '" . DB::escape($anonymous_proxy) . "', proxy_score = '" . (float)$proxy_score . "', is_trans_proxy = '" . DB::escape($is_trans_proxy) . "', free_mail = '" . DB::escape($free_mail) . "', carder_email = '" . DB::escape($carder_email) . "', high_risk_username = '" . DB::escape($high_risk_username) . "', high_risk_password = '" . DB::escape($high_risk_password) . "', bin_match = '" . DB::escape($bin_match) . "', bin_country = '" . DB::escape($bin_country) . "',  bin_name_match = '" . DB::escape($bin_name_match) . "', bin_name = '" . DB::escape($bin_name) . "', bin_phone_match = '" . DB::escape($bin_phone_match) . "', bin_phone = '" . DB::escape($bin_phone) . "', customer_phone_in_billing_location = '" . DB::escape($customer_phone_in_billing_location) . "', ship_forward = '" . DB::escape($ship_forward) . "', city_postal_match = '" . DB::escape($city_postal_match) . "', ship_city_postal_match = '" . DB::escape($ship_city_postal_match) . "', score = '" . (float)$score . "', explanation = '" . DB::escape($explanation) . "', risk_score = '" . (float)$risk_score . "', queries_remaining = '" . (int)$queries_remaining . "', maxmind_id = '" . DB::escape($maxmind_id) . "', error = '" . DB::escape($error) . "', date_added = NOW()");
            }
        }
    ...
    public function getFraud($order_id) {
        $query = DB::query("SELECT * FROM `" . DB::prefix() . "order_fraud` WHERE order_id = '" . (int)$order_id . "'");
