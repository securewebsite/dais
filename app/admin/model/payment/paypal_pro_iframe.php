...
class PaypalProIframe extends Model {
    ...
    public function call($data) {
        ...
        if ($this->config->get('paypal_pro_iframe_test') == 1) {
            $api_endpoint = 'https://api-3t.sandbox.paypal.com/nvp';
        } else {
            $api_endpoint = 'https://api-3t.paypal.com/nvp';
        }
        
        $settings = array('USER' => $this->config->get('paypal_pro_iframe_user'), 'PWD' => $this->config->get('paypal_pro_iframe_password'), 'SIGNATURE' => $this->config->get('paypal_pro_iframe_sig'), 'VERSION' => '84', 'BUTTONSOURCE' => 'WM_PRO_Dais_UK_' . VERSION,);
