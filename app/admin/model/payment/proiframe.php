...
class Proiframe extends Model {
    ...
    public function call($data) {
        ...
        $settings = array('USER' => $this->config->get('proiframe_user'), 'PWD' => $this->config->get('proiframe_password'), 'SIGNATURE' => $this->config->get('proiframe_sig'), 'VERSION' => '84', 'BUTTONSOURCE' => 'WM_PRO_Dais_UK_' . VERSION,);
