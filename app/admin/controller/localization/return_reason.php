...
class ReturnReason extends Controller {
    ...
    public function index() {
        Lang::load('localization/return_reason');
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            Response::redirect(Url::link('localization/return_reason', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    protected function getList() {
        ...
        Breadcrumb::add('lang_heading_title', 'localization/return_reason', $url);
        
        $data['insert'] = Url::link('localization/return_reason/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['delete'] = Url::link('localization/return_reason/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        foreach ($results as $result) {
            ...
            $action[] = array('text' => Lang::get('lang_text_edit'), 'href' => Url::link('localization/return_reason/update', 'token=' . $this->session->data['token'] . '&return_reason_id=' . $result['return_reason_id'] . $url, 'SSL'));
        ...
        $data['sort_name'] = Url::link('localization/return_reason', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
        ...
        $data['pagination'] = Theme::paginate($return_reason_total, $page, Config::get('config_admin_limit'), Lang::get('lang_text_pagination'), Url::link('localization/return_reason', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL'));
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['return_reason_id'])) {
            $data['action'] = Url::link('localization/return_reason/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
            $data['action'] = Url::link('localization/return_reason/update', 'token=' . $this->session->data['token'] . '&return_reason_id=' . $this->request->get['return_reason_id'] . $url, 'SSL');
        }
        
        $data['cancel'] = Url::link('localization/return_reason', 'token=' . $this->session->data['token'] . $url, 'SSL');
