...
class SaleTax extends Controller {
    public function index() {
        ...
        $this->breadcrumb->add('lang_heading_title', 'report/sale_tax', $url);
        ...
        $data['pagination'] = $this->theme->paginate($order_total, $page, $this->config->get('config_admin_limit'), $this->language->get('lang_text_pagination'), $this->url->link('report/sale_tax', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL'));
