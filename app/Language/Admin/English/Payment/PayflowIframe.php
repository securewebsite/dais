...
class PayflowIFrame {
	public static function lang() {
		...
		$_['lang_text_payflow_iframe']             = '<a onclick="window.open(\'\');"><img src="asset/default/img/payment/paypal.png" alt="PayPal Payflow Pro" title="PayPal Payflow Pro iFrame" style="border: 1px solid #EEEEEE;" /></a>';
