	...
	<form class="form-horizontal">
		...
		<div id="shipping-new" style="display: <?= ($addresses ? 'none' : 'block'); ?>;">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="postcode" value="" class="form-control" placeholder="<?= $lang_entry_postcode; ?>"  id="postcode" required>
				</div>
			</div>
			<div class="form-group">
...
<div class="panel-footer text-right">
	<button type="button" id="button-shipping-address" class="btn btn-primary load-left"><?= $lang_button_continue; ?></button>
</div>
<?= $javascript; ?>