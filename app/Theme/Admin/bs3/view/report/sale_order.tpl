		...
		<table class="table table-bordered table-striped">
			<thead>
				<tr>
					...
					<th class="text-right hidden-xs"><?= $lang_column_orders; ?></th>
					<th class="text-right hidden-xs"><?= $lang_column_products; ?></th>
					<th class="text-right hidden-xs"><?= $lang_column_tax; ?></th>
