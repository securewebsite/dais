		...
		<form class="form-horizontal" action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form">
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="paypalprouk_username" value="<?= $paypalprouk_username; ?>" class="form-control" autofocus>
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="paypalprouk_password" value="<?= $paypalprouk_password; ?>" class="form-control">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="paypalprouk_signature" value="<?= $paypalprouk_signature; ?>" class="form-control">
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<?php if ($paypalprouk_test) { ?>
					<label class="radio-inline"><input type="radio" name="paypalprouk_test" value="1" checked=""><?= $lang_text_yes; ?></label>
					<label class="radio-inline"><input type="radio" name="paypalprouk_test" value="0"><?= $lang_text_no; ?></label>
					<?php } else { ?>
					<label class="radio-inline"><input type="radio" name="paypalprouk_test" value="1"><?= $lang_text_yes; ?></label>
					<label class="radio-inline"><input type="radio" name="paypalprouk_test" value="0" checked=""><?= $lang_text_no; ?></label>
					<?php } ?>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<select name="paypalprouk_transaction" class="form-control">
						<?php if (!$paypalprouk_transaction) { ?>
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="paypalprouk_total" value="<?= $paypalprouk_total; ?>" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2"><?= $lang_entry_order_status; ?></label>
				<div class="control-field col-sm-4">
					<select name="paypalprouk_order_status_id" class="form-control">
						<?php foreach ($order_statuses as $order_status) { ?>
						<?php if ($order_status['order_status_id'] == $paypalprouk_order_status_id) { ?>
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<select name="paypalprouk_geo_zone_id" class="form-control">
						<option value="0"><?= $lang_text_all_zones; ?></option>
						<?php foreach ($geo_zones as $geo_zone) { ?>
						<?php if ($geo_zone['geo_zone_id'] == $paypalprouk_geo_zone_id) { ?>
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<select name="paypalprouk_status" class="form-control">
						<?php if ($paypalprouk_status) { ?>
			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<input type="text" name="paypalprouk_sort_order" value="<?= $paypalprouk_sort_order; ?>" class="form-control">
				</div>
			</div>
		</form>
	</div>
