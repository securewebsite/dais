			...
			<div class="form-group">
				...
				<div class="control-field col-sm-4">
					<?php foreach ($languages as $language) { ?>
						<div class="input-group"><input type="text" name="gift_card_theme_description[<?= $language['language_id']; ?>][name]" value="<?= isset($gift_card_theme_description[$language['language_id']]) ? $gift_card_theme_description[$language['language_id']]['name'] :''; ?>" class="form-control">
